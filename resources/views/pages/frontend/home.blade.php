...
@section('content')
                    ...
                    <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <div class="slider_text_box">
                            ...
                            data-textAlign="['left','left','left','left','left','center']">
                                <img src="{{asset('app-assets/img/home-slider/slider-m-1.png')}}" alt="">
                            </div>
                        </div>
                    </li>
        ...
        <section class="feature_area">
            <div class="container">
                <div class="c_title">
                    <img src="{{asset('app-assets/img/icon/title-icon.png')}}" alt="">
                ...
                <div class="row feature_inner">
                    <div class="col-lg-4 col-sm-6">
                        <div class="feature_item">
                            <div class="f_icon">
                                <img src="{{asset('app-assets/img/icon/f-icon-1.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="feature_item">
                            <div class="f_icon">
                                <img src="{{asset('app-assets/img/icon/f-icon-2.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="feature_item">
                            <div class="f_icon">
                                <img src="{{asset('app-assets/img/icon/f-icon-3.png')}}" alt="">
                            </div>
                            <h4>Social Media</h4>
                            <p>Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit am et tellus blandit. Etiam nec odio vestibul. </p>
                            <a class="more_btn" href="#">Read More</a>
            ...
            <div class="left_3d">
                <div class="shap_slider_inner owl-carousel">
                    <div class="item">
                        ...
                        <div class="media">
                            <img src="{{asset('app-assets/img/team/people/people-5.jpg')}}" alt="">
            ...
            <div class="right_text">
                <div class="right_text_inner">
                    ...
                    <div class="shap_mobile">
                        <img src="{{asset('app-assets/img/iphone4.png')}}" alt="">
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-6">
                                    <div class="team_img_item">
                                        <img src="{{asset('app-assets/img/team/people/people-1.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-6">
                                    <div class="team_img_item">
                                        <img src="{{asset('app-assets/img/team/people/people-2.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-6">
                                    <div class="team_img_item">
                                        <img src="{{asset('app-assets/img/team/people/people-3.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-6">
                                    <div class="team_img_item">
                                        <img src="{{asset('app-assets/img/team/people/people-4.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="world_map_area p_100">
            <div class="container">
                <div class="world_map_inner">
                    <img class="img-fluid" src="{{asset('app-assets/img/world-map.png')}}" alt="">
